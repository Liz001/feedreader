...
$(function() {
    ...
    describe('RSS Feeds', function() {
         ...
         */
        it('each feed has a defined URL and is not empty', function() {
    ...
    describe('The Menu', function() {
        ...
        /* 5. Test that ensures the menu changes
    ...
    describe('Initial Entries', function() {
        ...
        it('at least one entry is displayed', function(done) {
    ...
    describe('New Feed Selection', function() {
        ...
        it('content changed whenever loadFeed function execute', function(done) {
